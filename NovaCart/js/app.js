    ...
    target.innerHTML = `
      ...
      <nav class="nc-nav navbar navbar-expand-lg">
        <div class="container-nc w-100 d-flex align-items-center gap-3">
          ...
          <button class="navbar-toggler border-0 text-light" type="button" data-bs-toggle="collapse" data-bs-target="#ncNav"><span class="navbar-toggler-icon" style="filter:invert(1)"></span></button>
        ...
        <div class="container-nc">
          <div class="row g-4">
            <div class="col-lg-4 col-md-6">
              <a class="navbar-brand text-white" href="home.html" style="font-family:'Space Grotesk';font-weight:800;font-size:24px"><span class="brand-dot" style="display:inline-block;width:10px;height:10px;border-radius:50%;background:var(--nc-gradient);margin-right:8px"></span>NovaCart</a>
